...
public enum FfiConverterTypeValueOrContainer implements FfiConverter<ValueOrContainer, Pointer> {
    INSTANCE;

    @Override
    public Pointer lower(ValueOrContainer value) {
        return value.uniffiClonePointer();
    }

    @Override
    public ValueOrContainer lift(Pointer value) {
        return new ValueOrContainer(value);
    }
