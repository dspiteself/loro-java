...
public enum FfiConverterTypeLoroUnknown implements FfiConverter<LoroUnknown, Pointer> {
    INSTANCE;

    @Override
    public Pointer lower(LoroUnknown value) {
        return value.uniffiClonePointer();
    }

    @Override
    public LoroUnknown lift(Pointer value) {
        return new LoroUnknown(value);
    }
