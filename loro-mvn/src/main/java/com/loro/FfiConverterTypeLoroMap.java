...
public enum FfiConverterTypeLoroMap implements FfiConverter<LoroMap, Pointer> {
    INSTANCE;

    @Override
    public Pointer lower(LoroMap value) {
        return value.uniffiClonePointer();
    }

    @Override
    public LoroMap lift(Pointer value) {
        return new LoroMap(value);
    }
