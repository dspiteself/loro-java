...
public enum FfiConverterTypeSubscriber implements FfiConverter<Subscriber, Pointer> {
    INSTANCE;
    public final UniffiHandleMap<Subscriber> handleMap = new UniffiHandleMap<>();

    @Override
    public Pointer lower(Subscriber value) {
        return new Pointer(handleMap.insert(value));
    }

    @Override
    public Subscriber lift(Pointer value) {
        return new SubscriberImpl(value);
    }

    @Override
    public Subscriber read(ByteBuffer buf) {
    ...
    @Override
    public long allocationSize(Subscriber value) {
      return 8L;
    }

    @Override
    public void write(Subscriber value, ByteBuffer buf) {
