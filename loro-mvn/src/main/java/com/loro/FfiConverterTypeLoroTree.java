...
public enum FfiConverterTypeLoroTree implements FfiConverter<LoroTree, Pointer> {
    INSTANCE;

    @Override
    public Pointer lower(LoroTree value) {
        return value.uniffiClonePointer();
    }

    @Override
    public LoroTree lift(Pointer value) {
        return new LoroTree(value);
    }
