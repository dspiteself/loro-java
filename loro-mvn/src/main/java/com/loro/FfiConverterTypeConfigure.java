...
public enum FfiConverterTypeConfigure implements FfiConverter<Configure, Pointer> {
    INSTANCE;

    @Override
    public Pointer lower(Configure value) {
        return value.uniffiClonePointer();
    }

    @Override
    public Configure lift(Pointer value) {
        return new Configure(value);
    }

    @Override
    public Configure read(ByteBuffer buf) {
    ...
    @Override
    public long allocationSize(Configure value) {
      return 8L;
    }

    @Override
    public void write(Configure value, ByteBuffer buf) {
