...
public enum FfiConverterTypeFrontiers implements FfiConverter<Frontiers, Pointer> {
    INSTANCE;

    @Override
    public Pointer lower(Frontiers value) {
        return value.uniffiClonePointer();
    }

    @Override
    public Frontiers lift(Pointer value) {
        return new Frontiers(value);
    }
