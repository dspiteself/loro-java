...
public enum FfiConverterTypeLoroCounter implements FfiConverter<LoroCounter, Pointer> {
    INSTANCE;

    @Override
    public Pointer lower(LoroCounter value) {
        return value.uniffiClonePointer();
    }

    @Override
    public LoroCounter lift(Pointer value) {
        return new LoroCounter(value);
    }
