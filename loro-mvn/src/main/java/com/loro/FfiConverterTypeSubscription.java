...
public enum FfiConverterTypeSubscription implements FfiConverter<Subscription, Pointer> {
    INSTANCE;

    @Override
    public Pointer lower(Subscription value) {
        return value.uniffiClonePointer();
    }

    @Override
    public Subscription lift(Pointer value) {
        return new Subscription(value);
    }

    @Override
    public Subscription read(ByteBuffer buf) {
    ...
    @Override
    public long allocationSize(Subscription value) {
      return 8L;
    }

    @Override
    public void write(Subscription value, ByteBuffer buf) {
