...
public enum FfiConverterTypeLoroText implements FfiConverter<LoroText, Pointer> {
    INSTANCE;

    @Override
    public Pointer lower(LoroText value) {
        return value.uniffiClonePointer();
    }

    @Override
    public LoroText lift(Pointer value) {
        return new LoroText(value);
    }
