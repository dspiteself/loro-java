...
public enum FfiConverterTypeFractionalIndex implements FfiConverter<FractionalIndex, Pointer> {
    INSTANCE;

    @Override
    public Pointer lower(FractionalIndex value) {
        return value.uniffiClonePointer();
    }

    @Override
    public FractionalIndex lift(Pointer value) {
        return new FractionalIndex(value);
    }

    @Override
    public FractionalIndex read(ByteBuffer buf) {
    ...
    @Override
    public long allocationSize(FractionalIndex value) {
      return 8L;
    }

    @Override
    public void write(FractionalIndex value, ByteBuffer buf) {
