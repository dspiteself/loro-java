...
public enum FfiConverterTypeUnsubscriber implements FfiConverter<Unsubscriber, Pointer> {
    INSTANCE;
    public final UniffiHandleMap<Unsubscriber> handleMap = new UniffiHandleMap<>();

    @Override
    public Pointer lower(Unsubscriber value) {
        return new Pointer(handleMap.insert(value));
    }

    @Override
    public Unsubscriber lift(Pointer value) {
        return new UnsubscriberImpl(value);
    }

    @Override
    public Unsubscriber read(ByteBuffer buf) {
    ...
    @Override
    public long allocationSize(Unsubscriber value) {
      return 8L;
    }

    @Override
    public void write(Unsubscriber value, ByteBuffer buf) {
