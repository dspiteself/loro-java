...
public enum FfiConverterTypeAwareness implements FfiConverter<Awareness, Pointer> {
    INSTANCE;

    @Override
    public Pointer lower(Awareness value) {
        return value.uniffiClonePointer();
    }

    @Override
    public Awareness lift(Pointer value) {
        return new Awareness(value);
    }

    @Override
    public Awareness read(ByteBuffer buf) {
    ...
    @Override
    public long allocationSize(Awareness value) {
      return 8L;
    }

    @Override
    public void write(Awareness value, ByteBuffer buf) {
