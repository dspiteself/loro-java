...
public enum FfiConverterTypeLoroMovableList implements FfiConverter<LoroMovableList, Pointer> {
    INSTANCE;

    @Override
    public Pointer lower(LoroMovableList value) {
        return value.uniffiClonePointer();
    }

    @Override
    public LoroMovableList lift(Pointer value) {
        return new LoroMovableList(value);
    }
