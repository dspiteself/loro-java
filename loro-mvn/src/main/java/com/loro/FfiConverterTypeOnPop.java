...
public enum FfiConverterTypeOnPop implements FfiConverter<OnPop, Pointer> {
    INSTANCE;
    public final UniffiHandleMap<OnPop> handleMap = new UniffiHandleMap<>();

    @Override
    public Pointer lower(OnPop value) {
        return new Pointer(handleMap.insert(value));
    }

    @Override
    public OnPop lift(Pointer value) {
        return new OnPopImpl(value);
    }
