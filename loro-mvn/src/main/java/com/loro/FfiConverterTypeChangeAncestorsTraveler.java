...
public enum FfiConverterTypeChangeAncestorsTraveler implements FfiConverter<ChangeAncestorsTraveler, Pointer> {
    INSTANCE;
    public final UniffiHandleMap<ChangeAncestorsTraveler> handleMap = new UniffiHandleMap<>();

    @Override
    public Pointer lower(ChangeAncestorsTraveler value) {
        return new Pointer(handleMap.insert(value));
    }

    @Override
    public ChangeAncestorsTraveler lift(Pointer value) {
        return new ChangeAncestorsTravelerImpl(value);
    }

    @Override
    public ChangeAncestorsTraveler read(ByteBuffer buf) {
    ...
    @Override
    public long allocationSize(ChangeAncestorsTraveler value) {
      return 8L;
    }

    @Override
    public void write(ChangeAncestorsTraveler value, ByteBuffer buf) {
