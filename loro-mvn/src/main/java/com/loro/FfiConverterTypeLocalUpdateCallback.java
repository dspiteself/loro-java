...
public enum FfiConverterTypeLocalUpdateCallback implements FfiConverter<LocalUpdateCallback, Pointer> {
    INSTANCE;
    public final UniffiHandleMap<LocalUpdateCallback> handleMap = new UniffiHandleMap<>();

    @Override
    public Pointer lower(LocalUpdateCallback value) {
        return new Pointer(handleMap.insert(value));
    }

    @Override
    public LocalUpdateCallback lift(Pointer value) {
        return new LocalUpdateCallbackImpl(value);
    }

    @Override
    public LocalUpdateCallback read(ByteBuffer buf) {
    ...
    @Override
    public long allocationSize(LocalUpdateCallback value) {
      return 8L;
    }

    @Override
    public void write(LocalUpdateCallback value, ByteBuffer buf) {
