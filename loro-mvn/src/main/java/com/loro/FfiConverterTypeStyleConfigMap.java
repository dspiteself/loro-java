...
public enum FfiConverterTypeStyleConfigMap implements FfiConverter<StyleConfigMap, Pointer> {
    INSTANCE;

    @Override
    public Pointer lower(StyleConfigMap value) {
        return value.uniffiClonePointer();
    }

    @Override
    public StyleConfigMap lift(Pointer value) {
        return new StyleConfigMap(value);
    }

    @Override
    public StyleConfigMap read(ByteBuffer buf) {
    ...
    @Override
    public long allocationSize(StyleConfigMap value) {
      return 8L;
    }

    @Override
    public void write(StyleConfigMap value, ByteBuffer buf) {
