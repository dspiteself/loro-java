...
public enum FfiConverterTypeLoroList implements FfiConverter<LoroList, Pointer> {
    INSTANCE;

    @Override
    public Pointer lower(LoroList value) {
        return value.uniffiClonePointer();
    }

    @Override
    public LoroList lift(Pointer value) {
        return new LoroList(value);
    }
