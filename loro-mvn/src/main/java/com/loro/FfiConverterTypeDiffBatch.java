...
public enum FfiConverterTypeDiffBatch implements FfiConverter<DiffBatch, Pointer> {
    INSTANCE;

    @Override
    public Pointer lower(DiffBatch value) {
        return value.uniffiClonePointer();
    }

    @Override
    public DiffBatch lift(Pointer value) {
        return new DiffBatch(value);
    }

    @Override
    public DiffBatch read(ByteBuffer buf) {
    ...
    @Override
    public long allocationSize(DiffBatch value) {
      return 8L;
    }

    @Override
    public void write(DiffBatch value, ByteBuffer buf) {
