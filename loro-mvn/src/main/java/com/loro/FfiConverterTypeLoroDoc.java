...
public enum FfiConverterTypeLoroDoc implements FfiConverter<LoroDoc, Pointer> {
    INSTANCE;

    @Override
    public Pointer lower(LoroDoc value) {
        return value.uniffiClonePointer();
    }

    @Override
    public LoroDoc lift(Pointer value) {
        return new LoroDoc(value);
    }
