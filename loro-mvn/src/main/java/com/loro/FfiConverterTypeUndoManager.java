...
public enum FfiConverterTypeUndoManager implements FfiConverter<UndoManager, Pointer> {
    INSTANCE;

    @Override
    public Pointer lower(UndoManager value) {
        return value.uniffiClonePointer();
    }

    @Override
    public UndoManager lift(Pointer value) {
        return new UndoManager(value);
    }

    @Override
    public UndoManager read(ByteBuffer buf) {
    ...
    @Override
    public long allocationSize(UndoManager value) {
      return 8L;
    }

    @Override
    public void write(UndoManager value, ByteBuffer buf) {
