...
public enum FfiConverterTypeLoroValueLike implements FfiConverter<LoroValueLike, Pointer> {
    INSTANCE;
    public final UniffiHandleMap<LoroValueLike> handleMap = new UniffiHandleMap<>();

    @Override
    public Pointer lower(LoroValueLike value) {
        return new Pointer(handleMap.insert(value));
    }

    @Override
    public LoroValueLike lift(Pointer value) {
        return new LoroValueLikeImpl(value);
    }

    @Override
    public LoroValueLike read(ByteBuffer buf) {
    ...
    @Override
    public long allocationSize(LoroValueLike value) {
      return 8L;
    }

    @Override
    public void write(LoroValueLike value, ByteBuffer buf) {
